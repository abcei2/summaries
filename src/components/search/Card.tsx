...
const Card = ({ book, className }: { book: Book; className?: string }) => {
  ...
  return (
    <div
      className={`hover:before:bg-primary hover:before:opacity-40
        ${
        className ?? ""
      } rounded-[10px] w-[300px] shadow-lg border border-custom-black flex flex-col gap-4 justify-between px-3 py-4 text-xs`}
    >
